...
OpenData 是为 INDEVOLT 微型储能设备设计的一套开放数据通信框架，用户可以将微储接入自定义开发 App 或能源管理系统，实现设备数据查看、状态监控和远程控制。

无需依赖 INDEVOLT Server，即使在无互联网连接的情况下，用户仍可通过本地接口直接使用微储设备功能，保障设备在不同应用场景下的灵活使用。
